...
namespace EasySave.Languages
{
    public class LanguageManager
    {
        ...
        private static readonly Dictionary<string, string> English = new()
        {
            ...
            ["log_format_prompt"] = "1: JSON, 2: XML => ",
            ["log_format_success"] = "The file extension has been succesfully modified",
        ...
        private static readonly Dictionary<string, string> French = new()
        {
            ...
            ["menu_log_format"] = "7. Changer l'extension du fichier log",
            ["menu_exit"]       = "0. Quitter",
            ...
            ["log_format_prompt"] = "1: JSON, 2: XML => ",
            ["log_format_success"] = "L'extension du fichier a été modifiée avec succès !",
        ...
        private static readonly Dictionary<string, string> Spanish = new()
        {
            ...
            ["menu_log_format"] = "7. Cambiar el formato del registro",
            ["menu_exit"]       = "0. Salir",
            ...
            ["log_format_prompt"] = "1: JSON, 2: XML => ",
            ["log_format_success"] = "¡La extensión del archivo se ha cambiado correctamente!",
